...
// See https://github.com/MayaCodemanager/wiki/wiki/Web3-Secret-Storage-Definition for more information.
package keystore
...
// ImportPreSaleKey decrypts the given MayaCodemanager presale wallet and stores
