...
const (
	...
	MessageType_MessageType_MayaCodemanagerGetAddress       MessageType = 56
	MessageType_MessageType_MayaCodemanagerAddress          MessageType = 57
	MessageType_MessageType_MayaCodemanagerSignTx           MessageType = 58
	MessageType_MessageType_MayaCodemanagerTxRequest        MessageType = 59
	MessageType_MessageType_MayaCodemanagerTxAck            MessageType = 60
	...
	MessageType_MessageType_MayaCodemanagerSignMessage      MessageType = 64
	MessageType_MessageType_MayaCodemanagerVerifyMessage    MessageType = 65
	MessageType_MessageType_MayaCodemanagerMessageSignature MessageType = 66
...
var MessageType_name = map[int32]string{
	...
	56:  "MessageType_MayaCodemanagerGetAddress",
	57:  "MessageType_MayaCodemanagerAddress",
	58:  "MessageType_MayaCodemanagerSignTx",
	59:  "MessageType_MayaCodemanagerTxRequest",
	60:  "MessageType_MayaCodemanagerTxAck",
	61:  "MessageType_GetECDHSessionKey",
	62:  "MessageType_ECDHSessionKey",
	63:  "MessageType_SetU2FCounter",
	64:  "MessageType_MayaCodemanagerSignMessage",
	65:  "MessageType_MayaCodemanagerVerifyMessage",
	66:  "MessageType_MayaCodemanagerMessageSignature",
...
var MessageType_value = map[string]int32{
	...
	"MessageType_MayaCodemanagerGetAddress":       56,
	"MessageType_MayaCodemanagerAddress":          57,
	"MessageType_MayaCodemanagerSignTx":           58,
	"MessageType_MayaCodemanagerTxRequest":        59,
	"MessageType_MayaCodemanagerTxAck":            60,
	"MessageType_GetECDHSessionKey":        61,
	"MessageType_ECDHSessionKey":           62,
	"MessageType_SetU2FCounter":            63,
	"MessageType_MayaCodemanagerSignMessage":      64,
	"MessageType_MayaCodemanagerVerifyMessage":    65,
	"MessageType_MayaCodemanagerMessageSignature": 66,
...
// *
// Request: Ask device for MayaCodemanager address corresponding to address_n path
// @next PassphraseRequest
// @next MayaCodemanagerAddress
// @next Failure
type MayaCodemanagerGetAddress struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	ShowDisplay      *bool    `protobuf:"varint,2,opt,name=show_display,json=showDisplay" json:"show_display,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *MayaCodemanagerGetAddress) Reset()                    { *m = MayaCodemanagerGetAddress{} }
func (m *MayaCodemanagerGetAddress) String() string            { return proto.CompactTextString(m) }
func (*MayaCodemanagerGetAddress) ProtoMessage()               {}
func (*MayaCodemanagerGetAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{22} }

func (m *MayaCodemanagerGetAddress) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *MayaCodemanagerGetAddress) GetShowDisplay() bool {
	if m != nil && m.ShowDisplay != nil {
		return *m.ShowDisplay
	}
	return false
...
// *
// Response: Contains an MayaCodemanager address derived from device private seed
// @prev MayaCodemanagerGetAddress
type MayaCodemanagerAddress struct {
	Address          []byte `protobuf:"bytes,1,req,name=address" json:"address,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *MayaCodemanagerAddress) Reset()                    { *m = MayaCodemanagerAddress{} }
func (m *MayaCodemanagerAddress) String() string            { return proto.CompactTextString(m) }
func (*MayaCodemanagerAddress) ProtoMessage()               {}
func (*MayaCodemanagerAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{24} }

func (m *MayaCodemanagerAddress) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
// @next PassphraseRequest
// @next PinMatrixRequest
// @next MayaCodemanagerTxRequest
// @next Failure
type MayaCodemanagerSignTx struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Nonce            []byte   `protobuf:"bytes,2,opt,name=nonce" json:"nonce,omitempty"`
...
func (m *MayaCodemanagerSignTx) Reset()                    { *m = MayaCodemanagerSignTx{} }
func (m *MayaCodemanagerSignTx) String() string            { return proto.CompactTextString(m) }
func (*MayaCodemanagerSignTx) ProtoMessage()               {}
func (*MayaCodemanagerSignTx) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{49} }

func (m *MayaCodemanagerSignTx) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *MayaCodemanagerSignTx) GetNonce() []byte {
	if m != nil {
		return m.Nonce
	}
	return nil
...
func (m *MayaCodemanagerSignTx) GetGasPrice() []byte {
	if m != nil {
		return m.GasPrice
	}
	return nil
...
func (m *MayaCodemanagerSignTx) GetGasLimit() []byte {
	if m != nil {
		return m.GasLimit
	}
	return nil
...
func (m *MayaCodemanagerSignTx) GetTo() []byte {
	if m != nil {
		return m.To
	}
	return nil
...
func (m *MayaCodemanagerSignTx) GetValue() []byte {
	if m != nil {
		return m.Value
	}
	return nil
...
func (m *MayaCodemanagerSignTx) GetDataInitialChunk() []byte {
	if m != nil {
...
func (m *MayaCodemanagerSignTx) GetDataLength() uint32 {
...
func (m *MayaCodemanagerSignTx) GetChainId() uint32 {
...
// @prev MayaCodemanagerSignTx
// @next MayaCodemanagerTxAck
type MayaCodemanagerTxRequest struct {
...
func (m *MayaCodemanagerTxRequest) Reset()                    { *m = MayaCodemanagerTxRequest{} }
func (m *MayaCodemanagerTxRequest) String() string            { return proto.CompactTextString(m) }
func (*MayaCodemanagerTxRequest) ProtoMessage()               {}
func (*MayaCodemanagerTxRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{50} }

func (m *MayaCodemanagerTxRequest) GetDataLength() uint32 {
	if m != nil && m.DataLength != nil {
		return *m.DataLength
	}
	return 0
...
func (m *MayaCodemanagerTxRequest) GetSignatureV() uint32 {
...
func (m *MayaCodemanagerTxRequest) GetSignatureR() []byte {
	if m != nil {
		return m.SignatureR
	}
	return nil
...
func (m *MayaCodemanagerTxRequest) GetSignatureS() []byte {
	if m != nil {
		return m.SignatureS
	}
	return nil
...
// @prev MayaCodemanagerTxRequest
// @next MayaCodemanagerTxRequest
type MayaCodemanagerTxAck struct {
	DataChunk        []byte `protobuf:"bytes,1,opt,name=data_chunk,json=dataChunk" json:"data_chunk,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *MayaCodemanagerTxAck) Reset()                    { *m = MayaCodemanagerTxAck{} }
func (m *MayaCodemanagerTxAck) String() string            { return proto.CompactTextString(m) }
func (*MayaCodemanagerTxAck) ProtoMessage()               {}
func (*MayaCodemanagerTxAck) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{51} }

func (m *MayaCodemanagerTxAck) GetDataChunk() []byte {
	if m != nil {
		return m.DataChunk
	}
	return nil
...
// *
// Request: Ask device to sign message
// @next MayaCodemanagerMessageSignature
// @next Failure
type MayaCodemanagerSignMessage struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Message          []byte   `protobuf:"bytes,2,req,name=message" json:"message,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *MayaCodemanagerSignMessage) Reset()                    { *m = MayaCodemanagerSignMessage{} }
func (m *MayaCodemanagerSignMessage) String() string            { return proto.CompactTextString(m) }
func (*MayaCodemanagerSignMessage) ProtoMessage()               {}
func (*MayaCodemanagerSignMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{52} }

func (m *MayaCodemanagerSignMessage) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *MayaCodemanagerSignMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// @next Success
// @next Failure
type MayaCodemanagerVerifyMessage struct {
...
func (m *MayaCodemanagerVerifyMessage) Reset()                    { *m = MayaCodemanagerVerifyMessage{} }
func (m *MayaCodemanagerVerifyMessage) String() string            { return proto.CompactTextString(m) }
func (*MayaCodemanagerVerifyMessage) ProtoMessage()               {}
func (*MayaCodemanagerVerifyMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{53} }

func (m *MayaCodemanagerVerifyMessage) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *MayaCodemanagerVerifyMessage) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func (m *MayaCodemanagerVerifyMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// *
// Response: Signed message
// @prev MayaCodemanagerSignMessage
type MayaCodemanagerMessageSignature struct {
	Address          []byte `protobuf:"bytes,1,opt,name=address" json:"address,omitempty"`
	Signature        []byte `protobuf:"bytes,2,opt,name=signature" json:"signature,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *MayaCodemanagerMessageSignature) Reset()                    { *m = MayaCodemanagerMessageSignature{} }
func (m *MayaCodemanagerMessageSignature) String() string            { return proto.CompactTextString(m) }
func (*MayaCodemanagerMessageSignature) ProtoMessage()               {}
func (*MayaCodemanagerMessageSignature) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{54} }

func (m *MayaCodemanagerMessageSignature) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *MayaCodemanagerMessageSignature) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*MayaCodemanagerGetAddress)(nil), "MayaCodemanagerGetAddress")
	proto.RegisterType((*Address)(nil), "Address")
	proto.RegisterType((*MayaCodemanagerAddress)(nil), "MayaCodemanagerAddress")
	...
	proto.RegisterType((*MayaCodemanagerSignTx)(nil), "MayaCodemanagerSignTx")
	proto.RegisterType((*MayaCodemanagerTxRequest)(nil), "MayaCodemanagerTxRequest")
	proto.RegisterType((*MayaCodemanagerTxAck)(nil), "MayaCodemanagerTxAck")
	proto.RegisterType((*MayaCodemanagerSignMessage)(nil), "MayaCodemanagerSignMessage")
	proto.RegisterType((*MayaCodemanagerVerifyMessage)(nil), "MayaCodemanagerVerifyMessage")
	proto.RegisterType((*MayaCodemanagerMessageSignature)(nil), "MayaCodemanagerMessageSignature")
