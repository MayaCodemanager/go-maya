...
// Package bind generates MayaCodemanager contract Go bindings.
//
// Detailed usage document and tutorial available on the go-maya Wiki page:
// https://github.com/MayaCodemanager/go-maya/wiki/Native-DApps:-Go-bindings-to-MayaCodemanager-contracts
package bind
