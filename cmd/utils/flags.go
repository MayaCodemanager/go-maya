...
// Package utils contains internal helper functions for go-maya commands.
package utils
...
import (
	...
	"github.com/MayaCodemanager/go-maya/common/fdlimit"
	...
	"github.com/MayaCodemanager/go-maya/dashboard"
	...
	"github.com/MayaCodemanager/go-maya/metrics"
	"github.com/MayaCodemanager/go-maya/metrics/influxdb"
	...
	"github.com/MayaCodemanager/go-maya/p2p/netutil"
...
// RegisterEthService adds an MayaCodemanager client to the stack.
func RegisterEthService(stack *node.Node, cfg *eth.Config) {
	...
	if err != nil {
		Fatalf("Failed to register the MayaCodemanager service: %v", err)
	}
}
...
// RegisterEthStatsService configures the MayaCodemanager Stats daemon and adds it to
// the given node.
func RegisterEthStatsService(stack *node.Node, url string) {
	if err := stack.Register(func(ctx *node.ServiceContext) (node.Service, error) {
		// Retrieve both eth and les services
		var ethServ *eth.MayaCodemanager
		ctx.Service(&ethServ)
		...
		Fatalf("Failed to register the MayaCodemanager Stats service: %v", err)
	}
}
