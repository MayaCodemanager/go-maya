...
import (
	...
	"github.com/MayaCodemanager/go-maya/signer/core"
	"github.com/MayaCodemanager/go-maya/signer/rules"
	"github.com/MayaCodemanager/go-maya/signer/storage"
...
func init() {
	app.Name = "Clef"
	app.Usage = "Manage MayaCodemanager account operations"
	app.Flags = []cli.Flag{
		logLevelFlag,
		keystoreFlag,
		configdirFlag,
