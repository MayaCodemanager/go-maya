...
type wizard struct {
	...
	services map[string][]string   // MayaCodemanager services known to be running on servers
...
// it to an MayaCodemanager address.
...
// converts it to an MayaCodemanager address. If an empty line is entered, the default
// value is returned.
