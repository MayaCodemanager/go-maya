...
// setting up a new or managing an existing MayaCodemanager private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your MayaCodemanager private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new MayaCodemanager network down to  |")
	...
	log.Info("Administering MayaCodemanager network", "name", w.network)
