...
import (
	...
	"github.com/MayaCodemanager/go-maya/cmd/utils"
	"github.com/MayaCodemanager/go-maya/common"
	"github.com/MayaCodemanager/go-maya/console"
	...
	"github.com/MayaCodemanager/go-maya/swarm"
	bzzapi "github.com/MayaCodemanager/go-maya/swarm/api"
	swarmmetrics "github.com/MayaCodemanager/go-maya/swarm/metrics"
	"github.com/MayaCodemanager/go-maya/swarm/tracing"
...
var app = utils.NewApp("", "MayaCodemanager Swarm")

// This init function creates the cli.App.
func init() {
	app.Action = bzzd
	app.Version = sv.ArchiveVersion(gitCommit)
	app.Copyright = "Copyright 2013-2016 The go-maya Authors"
...
func bzzd(ctx *cli.Context) error {
	...
	//setup the MayaCodemanager node
	...
	//register BZZ as node.Service in the MayaCodemanager node
...
func registerBzzService(bzzconfig *bzzapi.Config, stack *node.Node) {
	...
	//register within the MayaCodemanager node
