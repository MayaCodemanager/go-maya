...
import (
	...
	"github.com/MayaCodemanager/go-maya/common/bitutil"
...
const (
	// bloomServiceThreads is the number of goroutines used globally by an MayaCodemanager
...
func (eth *MayaCodemanager) startBloomHandlers(sectionSize uint64) {
...
// for the MayaCodemanager header bloom filters, permitting blazing fast filtering.
