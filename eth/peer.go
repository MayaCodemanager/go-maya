...
// PeerInfo represents a short summary of the MayaCodemanager sub-protocol metadata known
// about a connected peer.
type PeerInfo struct {
	Version    int      `json:"version"`    // MayaCodemanager protocol version negotiated
...
// the MayaCodemanager sub-protocol.
type peerSet struct {
