...
// Package filters implements an MayaCodemanager filtering system for block,
...
type subscription struct {
	...
	typ       Type
	created   time.Time
	logsCrit  MayaCodemanager.FilterQuery
	logs      chan []*types.Log
...
func (es *EventSystem) SubscribeLogs(crit MayaCodemanager.FilterQuery, logs chan []*types.Log) (*Subscription, error) {
...
func (es *EventSystem) subscribeMinedPendingLogs(crit MayaCodemanager.FilterQuery, logs chan []*types.Log) *Subscription {
	sub := &subscription{
		id:        rpc.NewID(),
...
func (es *EventSystem) subscribeLogs(crit MayaCodemanager.FilterQuery, logs chan []*types.Log) *Subscription {
	sub := &subscription{
		id:        rpc.NewID(),
...
func (es *EventSystem) subscribePendingLogs(crit MayaCodemanager.FilterQuery, logs chan []*types.Log) *Subscription {
	sub := &subscription{
		id:        rpc.NewID(),
