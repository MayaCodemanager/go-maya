...
func testSyncProgress(t *testing.T, protocol int, mode SyncMode) {
	...
	checkProgress(t, tester.downloader, "pristine", MayaCodemanager.SyncProgress{})
	...
	<-starting
	checkProgress(t, tester.downloader, "initial", MayaCodemanager.SyncProgress{
	...
	<-starting
	checkProgress(t, tester.downloader, "completing", MayaCodemanager.SyncProgress{
	...
	progress <- struct{}{}
	pending.Wait()
	checkProgress(t, tester.downloader, "final", MayaCodemanager.SyncProgress{
		StartingBlock: uint64(chain.len()/2 - 1),
...
func checkProgress(t *testing.T, d *Downloader, stage string, want MayaCodemanager.SyncProgress) {
	// Mark this method as a helper to report errors at callsite, not in here
	t.Helper()
...
func testForkedSyncProgress(t *testing.T, protocol int, mode SyncMode) {
	...
	<-starting
	checkProgress(t, tester.downloader, "forking", MayaCodemanager.SyncProgress{
