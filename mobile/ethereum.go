...
// Contains all the wrappers from the go-maya root package.
...
type Subscription struct {
	sub MayaCodemanager.Subscription
}
...
// the MayaCodemanager network.
type SyncProgress struct {
	progress MayaCodemanager.SyncProgress
}
...
type FilterQuery struct {
	query MayaCodemanager.FilterQuery
}
