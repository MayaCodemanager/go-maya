...
// Contains a wrapper for the MayaCodemanager client.
...
// MayaCodemanagerClient provides access to the MayaCodemanager APIs.
type MayaCodemanagerClient struct {
	client *ethclient.Client
}

// NewMayaCodemanagerClient connects a client to the given URL.
func NewMayaCodemanagerClient(rawurl string) (client *MayaCodemanagerClient, _ error) {
	rawClient, err := ethclient.Dial(rawurl)
	return &MayaCodemanagerClient{rawClient}, err
}

// GetBlockByHash returns the given full block.
func (ec *MayaCodemanagerClient) GetBlockByHash(ctx *Context, hash *Hash) (block *Block, _ error) {
...
func (ec *MayaCodemanagerClient) GetBlockByNumber(ctx *Context, number int64) (block *Block, _ error) {
	if number < 0 {
...
func (ec *MayaCodemanagerClient) GetHeaderByHash(ctx *Context, hash *Hash) (header *Header, _ error) {
...
func (ec *MayaCodemanagerClient) GetHeaderByNumber(ctx *Context, number int64) (header *Header, _ error) {
	if number < 0 {
...
func (ec *MayaCodemanagerClient) GetTransactionByHash(ctx *Context, hash *Hash) (tx *Transaction, _ error) {
...
func (ec *MayaCodemanagerClient) GetTransactionSender(ctx *Context, tx *Transaction, blockhash *Hash, index int) (sender *Address, _ error) {
...
func (ec *MayaCodemanagerClient) GetTransactionCount(ctx *Context, hash *Hash) (count int, _ error) {
...
func (ec *MayaCodemanagerClient) GetTransactionInBlock(ctx *Context, hash *Hash, index int) (tx *Transaction, _ error) {
...
func (ec *MayaCodemanagerClient) GetTransactionReceipt(ctx *Context, hash *Hash) (receipt *Receipt, _ error) {
...
func (ec *MayaCodemanagerClient) SyncProgress(ctx *Context) (progress *SyncProgress, _ error) {
...
func (ec *MayaCodemanagerClient) SubscribeNewHead(ctx *Context, handler NewHeadHandler, buffer int) (sub *Subscription, _ error) {
...
func (ec *MayaCodemanagerClient) GetBalanceAt(ctx *Context, account *Address, number int64) (balance *BigInt, _ error) {
	if number < 0 {
...
func (ec *MayaCodemanagerClient) GetStorageAt(ctx *Context, account *Address, key *Hash, number int64) (storage []byte, _ error) {
	if number < 0 {
...
func (ec *MayaCodemanagerClient) GetCodeAt(ctx *Context, account *Address, number int64) (code []byte, _ error) {
	if number < 0 {
...
func (ec *MayaCodemanagerClient) GetNonceAt(ctx *Context, account *Address, number int64) (nonce int64, _ error) {
	if number < 0 {
...
func (ec *MayaCodemanagerClient) FilterLogs(ctx *Context, query *FilterQuery) (logs *Logs, _ error) {
...
func (ec *MayaCodemanagerClient) SubscribeFilterLogs(ctx *Context, query *FilterQuery, handler FilterLogsHandler, buffer int) (sub *Subscription, _ error) {
	// Subscribe to the event internally
...
func (ec *MayaCodemanagerClient) GetPendingBalanceAt(ctx *Context, account *Address) (balance *BigInt, _ error) {
...
func (ec *MayaCodemanagerClient) GetPendingStorageAt(ctx *Context, account *Address, key *Hash) (storage []byte, _ error) {
...
func (ec *MayaCodemanagerClient) GetPendingCodeAt(ctx *Context, account *Address) (code []byte, _ error) {
...
func (ec *MayaCodemanagerClient) GetPendingNonceAt(ctx *Context, account *Address) (nonce int64, _ error) {
...
func (ec *MayaCodemanagerClient) GetPendingTransactionCount(ctx *Context) (count int, _ error) {
...
func (ec *MayaCodemanagerClient) CallContract(ctx *Context, msg *CallMsg, number int64) (output []byte, _ error) {
	if number < 0 {
...
func (ec *MayaCodemanagerClient) PendingCallContract(ctx *Context, msg *CallMsg) (output []byte, _ error) {
	return ec.client.PendingCallContract(ctx.context, msg.msg)
}

// SuggestGasPrice retrieves the currently suggested gas price to allow a timely
// execution of a transaction.
func (ec *MayaCodemanagerClient) SuggestGasPrice(ctx *Context) (price *BigInt, _ error) {
...
func (ec *MayaCodemanagerClient) EstimateGas(ctx *Context, msg *CallMsg) (gas int64, _ error) {
...
func (ec *MayaCodemanagerClient) SendTransaction(ctx *Context, tx *Transaction) error {
