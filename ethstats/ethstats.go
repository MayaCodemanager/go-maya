...
// Service implements an MayaCodemanager netstats reporting daemon that pushes local
// chain statistics up to a monitoring server.
type Service struct {
	server *p2p.Server        // Peer-to-peer server to retrieve networking infos
	eth    *eth.MayaCodemanager      // Full MayaCodemanager service if monitoring a full node
	les    *les.LightMayaCodemanager // Light MayaCodemanager service if monitoring a light node
...
func New(url string, ethServ *eth.MayaCodemanager, lesServ *les.LightMayaCodemanager) (*Service, error) {
