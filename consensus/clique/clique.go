...
import (
	...
	"github.com/MayaCodemanager/go-maya/crypto/sha3"
...
// ecrecover extracts the MayaCodemanager account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the MayaCodemanager address
...
// MayaCodemanager testnet following the Ropsten attacks.
type Clique struct {
	...
	signer common.Address // MayaCodemanager address of the signing key
...
// Author implements consensus.Engine, returning the MayaCodemanager address recovered
