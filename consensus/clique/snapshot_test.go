...
// mapped from textual names used in the tests below to actual MayaCodemanager private
...
// address retrieves the MayaCodemanager address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the MayaCodemanager address
...
func TestClique(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			// batch (https://github.com/MayaCodemanager/go-maya/issues/17593). Whilst this
