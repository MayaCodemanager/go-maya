...
// stateObject represents an MayaCodemanager account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of MayaCodemanager address of the account
	data     Account
	db       *StateDB
...
// Account is the MayaCodemanager consensus representation of accounts.
